...
exports = {
	...
	/**
	 * collidesWith defines how collisions behave and what data is returned
	 * the default returns a bool, and only works with circles and rects
	 */
	collidesWith: function(entity1, entity2) {
		if (entity1.isCircle) {
			if (entity2.isCircle) {
	...
	/**
	 * circle and rect collision functions are needed by default collidesWith
